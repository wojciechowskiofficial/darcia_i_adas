...
public class Indexer
{
    ...
    private Document getHTMLDocument(String path, int id)
    {
        ...
        */
        ...
        // ----------------------------------
        TextField storedAndIndexedField = new TextField(Constants.filename, file.getName(), Field.Store.YES);
        // ----------------------------------

        // TODO create an INT field (IntPoint) that is indexed
        // and contains file size (bytes, .length())
        // ----------------------------------
        IntPoint intIndexedField = new IntPoint(Constants.filesize_int, (int)file.length());
        ...
        document.add(storedAndIndexedField);
        document.add(intIndexedField);
